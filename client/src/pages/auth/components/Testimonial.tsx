import CalComLogo from "@/images/cal-logo-light.svg"; // Adjust the path as needed
import Peer from "@/images/peer.webp"; // Adjust the path as needed
        ...
        <div className="rounded-xl border border-slate-200 bg-gradient-to-tr from-slate-100 to-slate-200 p-8">
          ...
          <div className="mt-4 flex items-center space-x-6">
            ...
            <div>
              ...
              <img src={CalComLogo} alt="Cal.com Logo" />
            </div>
          </div>
        </div>
      </div>
